  ...
  var a, k, g = "",
    ...
    c = {
      ...
      openCart: function() {
        var b = 0;
        a = c.getStorage();
        g = '<p class="jqcart-cart-titlee">\u041a\u043e\u0440\u0437\u0438\u043d\u0430 <span class="jqcart-print-order"></span></p><div class="jqcart-table-wrapper"><div class="jqcart-manage-order" id="pkb"><div class="jqcart-thead"><div></div><div></div></div>';
        var e;
        for (e in a)
        ...
        b = b ? g + '<p class="jqcart-cart-title">\u041a\u043e\u043d\u0442\u0430\u043a\u0442\u043d\u0430\u044f \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044f:</p><form class="jqcart-orderform"><p><a href="index2.html"><input type="button" id="lkj" value="Оформить заказ"></a><input type="reset" id="lkj" style="" onclick="poty2()" id="naz" value="\u0412\u0435\u0440\u043d\u0443\u0442\u044c\u0441\u044f \u043a \u043f\u043e\u043a\u0443\u043f\u043a\u0430\u043c"></p></form>' :
          '<h2 class="jqcart-empty-cart">\u041a\u043e\u0440\u0437\u0438\u043d\u0430 \u043f\u0443\u0441\u0442\u0430</h2>';
        d('<div class="jqcart-layout" id="org"><div class="jqcart-checkout" id="red">123</div></div>').appendTo("body").find(".jqcart-checkout").html(b)
      },
      hideCart: function() {
